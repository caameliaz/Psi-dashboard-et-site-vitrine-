...
export interface Prod { id: string; reference: string; width: number; length: number; usage: string; price: number; photo?: string | null; category?: { id: string; name: string } | null }
