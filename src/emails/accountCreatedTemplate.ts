...
export function renderWelcomeEmailNoPassword(params: {
  ...
  const body = `
    ...
    <div style="background:#F8FAFC;border:1px solid #E2E8F0;border-radius:12px;padding:18px;margin-bottom:20px">
      <p style="margin:0 0 12px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;color:#8A9BB5">Votre email de connexion</p>
      <p style="margin:0;font-size:14px;font-weight:700;color:#0F172A">${email}</p>
    </div>

    <p style="margin:0 0 20px;font-size:12px;color:#8A9BB5">Pour obtenir votre mot de passe, contactez un administrateur. Une fois reçu, vous pourrez vous connecter et le modifier depuis votre profil.</p>
